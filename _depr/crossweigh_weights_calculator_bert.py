...
from examples.data_preprocessing.tac_based_dataset.utils.lfs_reconstructor import get_labels
...
class WSCrossWeighWeightsCalculator:
    ...
    def _get_cw_samples_labels_idx(
        ...
        """
        sample_ids = [list(rules_samples_ids_dict[idx]) for idx in indices]

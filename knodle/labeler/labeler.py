...
from knodle.labeler.config import LabelerConfig, BaseLabelerConfigConfig
...
class Labeler(ABC):
    def __init__(
        ...
        if labeler_config is None:
            self.labeler_config = LabelerConfig(model)
        else:
            self.labeler_config = labeler_config


class BaseLabeler(Labeler):
    ...
    def __init__(
        ...
        if kwargs.get("labeler_config", None) is None:
            kwargs["labeler_config"] = BaseTrainerConfig()

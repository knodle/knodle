...
def preprocess_data(
    ...
    get_dev_test_data(path_dev_data, path_output, labels2ids, T_MATRIX_OUTPUT_DEV, Z_MATRIX_OUTPUT_DEV, DEV_SAMPLES_OUTPUT)
    get_dev_test_data(path_test_data, path_output, labels2ids, T_MATRIX_OUTPUT_TEST, Z_MATRIX_OUTPUT_TEST, TEST_SAMPLES_OUTPUT)
...
def get_train_data(path_train_data: str, path_output: str, labels2ids: dict) -> None:
    ...
    dump(rule_assignments_t, os.path.join(path_output, T_MATRIX_OUTPUT_TRAIN))
...
def get_dev_test_data(path_data: str, path_output: str, labels2ids: dict, t_matrix: str, z_matrix: str, samples: str) -> None:
    """
    ...
    val_data, relation2rules, _ = get_conll_data_with_ent_pairs(path_data, labels2ids)

...
X_train_tfidf, X_dev_tfidf, X_test_tfidf = get_tfidf_features(
    train_data=df_train["sample"].tolist(), dev_data=df_dev["sample"].tolist(),
    test_data=df_test["sample"].tolist(), max_features = 1000
)
